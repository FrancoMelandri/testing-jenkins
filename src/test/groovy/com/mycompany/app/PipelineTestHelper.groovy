...
class PipelineTestHelper extends BasePipelineTest {
    ...
    void registerScriptedMethods() {
        ...
        helper.registerAllowedMethod('usernamePassword', [Map.class], { creds -> 
            binding.setVariable(creds.usernameVariable, creds[creds.usernameVariable])
            binding.setVariable(creds.passwordVariable, creds[creds.passwordVariable])
        })
